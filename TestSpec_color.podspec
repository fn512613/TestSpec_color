...
Pod::Spec.new do |spec|
  ...
  spec.homepage     = "https://github.com/fn512613/TestSpec_color"
  ...
  spec.author             = { "QPP" => "fn512613@126.com" }
  # Or just: spec.author    = "钱盼盼"
  # spec.authors            = { "钱盼盼" => "qpanpan@qiujieda.com" }
  ...
  spec.source_files  = "TestSpec_color/TestSpec_color/*.{h,m}"
